        ...
        <section>
          ...
          >
            <div className="form-section">
              <label className="title" htmlFor="list-title">
                List title
              </label>
              <input
            ...
            <div className="form-section">
              <label className="title" htmlFor="trip-description">
                Trip summary
              </label>
              <textarea
            ...
            <div className="form-section">
              <label className="title" htmlFor="gear-list">
                Select Gear to Add
              </label>
              <ul className="gear-list">{gearOpts}</ul>
            </div>
