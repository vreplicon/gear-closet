        ...
        <section>
          ...
          >
            ...
            <div className="gear-type form-section">
              ...
              >
                <option> Rock Climbing </option> <option> Camping </option>{" "}
                <option> Other </option>{" "}
              </select>{" "}
            </div>
            ...
            <div className="form-section">
              ...
              >
                <option> oz </option> <option> lb </option> <option> g </option>{" "}
              </select>{" "}
            </div>
